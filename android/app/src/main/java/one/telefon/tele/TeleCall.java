...
*/
    ...
    */
    ...
    public void onCallMediaEvent(OnCallMediaEventParam prm) {
        ...
        // for (TeleVideoMediaChange listener : mediaListeners) {
        // listener.onChange();
        // }
    }
    */
...
/*
        ...
        if (state === STATE_CONNECTING) { 
            str_state='PJSIP_INV_STATE_CALLING';
            this.incoming=false;
        }
        if (state === STATE_RINGING) {
          str_state='PJSIP_INV_STATE_INCOMING';
          this.incoming=true;
        }

        if (state === STATE_DIALING) {
          str_state='PJSIP_INV_STATE_EARLY';
          this.incoming=false;
        }
        if (state === STATE_ACTIVE) {
          str_state='PJSIP_INV_STATE_CONFIRMED';
        }
        if (state === STATE_DISCONNECTED) {
          str_state='PJSIP_INV_STATE_DISCONNECTED';
 ...
 */
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            //if (info.getState() == "PJSIP_INV_STATE_CONFIRMED" || info.getState() == "PJSIP_INV_STATE_DISCONNECTED") {
